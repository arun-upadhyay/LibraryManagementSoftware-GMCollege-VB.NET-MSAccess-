...
Public Class frmBookEntry
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            '    MessageBox.Show("Please enter/select subject", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            '    cmbSubject.Focus()
            '    Exit Sub
            'End If
    ...
    Private Sub txtBookTitle_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtBookTitle.TextChanged
        Try
            If txtBookTitle.Text <> "" Then
                Dim a As String = txtBookTitle.Text
                txtBookTitle.Text = (StrConv(a, VbStrConv.ProperCase))
                txtBookTitle.Select(txtBookTitle.Text.Length, 0)
            End If
            If txtBookTitle.Text <> "" Then
                Dim a As String = txtBookTitle.Text
                txtBookTitle.Text = (StrConv(a, VbStrConv.ProperCase))
    ...
    Private Sub txtAuthor_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtAuthor.TextChanged
        Try
            If txtAuthor.Text <> "" Then
                Dim a As String = txtAuthor.Text
                txtAuthor.Text = (StrConv(a, VbStrConv.ProperCase))
                txtAuthor.Select(txtAuthor.Text.Length, 0)
            End If
            If txtAuthor.Text <> "" Then
                Dim a As String = txtAuthor.Text
                txtAuthor.Text = (StrConv(a, VbStrConv.ProperCase))
    ...
    Private Sub txtJointAuthor_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtJointAuthor.TextChanged
        Try
            If txtJointAuthor.Text <> "" Then
                Dim a As String = txtJointAuthor.Text
                txtJointAuthor.Text = (StrConv(a, VbStrConv.ProperCase))
                txtJointAuthor.Select(txtJointAuthor.Text.Length, 0)
            End If
            If txtJointAuthor.Text <> "" Then
                Dim a As String = txtJointAuthor.Text
                txtJointAuthor.Text = (StrConv(a, VbStrConv.ProperCase))
    ...
    Private Sub txtPublisherName_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtPublisherName.TextChanged
