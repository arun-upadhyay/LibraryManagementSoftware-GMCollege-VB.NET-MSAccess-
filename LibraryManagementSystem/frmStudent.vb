...
Public Class frmStudent
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            End If
            txtStudentID.Text = Trim(cmbCourse.Text) & Trim(txtSession.Text) & "-" & GetUniqueKey(2)
    ...
    Private Sub btnUpdate_record_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate_record.Click
        Try
            ...
            con = New OleDbConnection(cs)
            con.Open()
            Dim cb As String = "update Student set Studentname='" & txtStudentName.Text & "',Fathername='" & txtFatherName.Text & "',Course='" & cmbCourse.Text & "',Department='" & cmbDepartment.Text & "',Stu_Session='" & txtSession.Text & "',TemporaryAddress='" & txtTempAddress.Text & "',PermanentAddress='" & txtPermanentAddress.Text & "', PhoneNo='" & txtPhoneNo.Text & "', MobileNo='" & txtMobileNo.Text & "',Email='" & txtEmail.Text & "',Photo=@image,Gender='" & gender & "' where StudentID= '" & txtStudentID.Text & "'"
            cmd = New OleDbCommand(cb)
            cmd.Connection = con
            Dim ms As New MemoryStream()
            Dim bmpImage As New Bitmap(Picture.Image)
    ...
    Private Sub txtStudentName_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtStudentName.TextChanged
        Try
            If txtStudentName.Text <> "" Then
                Dim a As String = txtStudentName.Text
                txtStudentName.Text = (StrConv(a, VbStrConv.ProperCase))
                txtStudentName.Select(txtStudentName.Text.Length, 0)
            End If
            If txtStudentName.Text <> "" Then
                Dim a As String = txtStudentName.Text
                txtStudentName.Text = (StrConv(a, VbStrConv.ProperCase))
    ...
    Private Sub txtFatherName_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtFatherName.TextChanged
        Try
            If txtFatherName.Text <> "" Then
                Dim a As String = txtFatherName.Text
                txtFatherName.Text = (StrConv(a, VbStrConv.ProperCase))
                txtFatherName.Select(txtFatherName.Text.Length, 0)
            End If
            If txtFatherName.Text <> "" Then
                Dim a As String = txtFatherName.Text
                txtFatherName.Text = (StrConv(a, VbStrConv.ProperCase))
    ...
    Private Sub CheckBox1_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles CheckBox1.CheckedChanged
        If CheckBox1.Checked = True Then
            txtPermanentAddress.Text = txtTempAddress.Text
