...
Public Class frmBookIssueRecord_Staff
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            con = New OleDbConnection(cs)
            con.Open()
            cmd = New OleDbCommand("SELECT TransactionID as [Transaction ID], IssueDate as [Issue Date], DueDate as [Due Date], Book.AccessionNo as [Accession No],BookIssue_Student.BCode as [Book Code],BookTitle as [Book Title],Author,Subject,ISBN,Edition,Staff.StaffID as [Staff ID],StaffName as [Staff Name],Staff.Department, Status from Book,BookIssue_Staff,Staff where Book.AccessionNo=BookIssue_Staff.AccessionNo and BookIssue_Staff.StaffID=Staff.StaffID and IssueDate Between #" & DateTimePicker8.Text & "# and #" & DateTimePicker7.Text & "#  order by IssueDate desc ", con)
            Dim myDA As OleDbDataAdapter = New OleDbDataAdapter(cmd)
            Dim myDataSet As DataSet = New DataSet()
            myDA.Fill(myDataSet, "BookIssue_Staff")
            myDA.Fill(myDataSet, "Book")
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            ...
            Me.Hide()
            frmBookIssue.Show()
            frmBookIssue.txtTransactionID1.Text = dr.Cells("Transaction ID").Value.ToString()
            frmBookIssue.dtpIssueDate1.Text = dr.Cells("Issue Date").Value.ToString()
            frmBookIssue.dtpDueDate1.Text = dr.Cells("Due Date").Value.ToString()
            frmBookIssue.cmbAccessionNo1.Text = dr.Cells("Accession No").Value.ToString()
            frmBookIssue.CmbBookCode1.Text = dr.Cells("Book Code").Value.ToString()
            frmBookIssue.TextBox2.Text = dr.Cells("Accession No").Value.ToString()
            frmBookIssue.txtBookTitle1.Text = dr.Cells("Book Title").Value.ToString()
            frmBookIssue.txtAuthor1.Text = dr.Cells("Author").Value.ToString()
            frmBookIssue.txtCategory1.Text = dr.Cells("Subject").Value.ToString()
            frmBookIssue.txtISBN1.Text = dr.Cells("ISBN").Value.ToString()
            frmBookIssue.txtEdition1.Text = dr.Cells("Edition").Value.ToString()
            frmBookIssue.cmbStaffID.Text = dr.Cells("Staff ID").Value.ToString()
            frmBookIssue.txtStaffName.Text = dr.Cells("Staff Name").Value.ToString()
            frmBookIssue.txtDepartment1.Text = dr.Cells("Department").Value.ToString()
            frmBookIssue.txtStatus1.Text = dr.Cells("Status").Value.ToString()
    ...
    Private Sub Button3_Click(sender As System.Object, e As System.EventArgs) Handles Button3.Click
        Try
            con = New OleDbConnection(cs)
            con.Open()
            cmd = New OleDbCommand("SELECT TransactionID as [Transaction ID], IssueDate as [Issue Date], DueDate as [Due Date], Book.AccessionNo as [Accession No],BookIssue_Staff.BCode as [Book Code],BookTitle as [Book Title],Author,Subject,ISBN,Edition,Staff.StaffID as [Staff ID],StaffName as [Staff Name],Staff.Department, Status from Book,BookIssue_Staff,Staff where Book.AccessionNo=BookIssue_Staff.AccessionNo and BookIssue_Staff.StaffID=Staff.StaffID and BookIssue_Staff.AccessionNo='" & Trim(cmbAccNo.Text) & "' and BookIssue_Staff.BCode='" & Trim(cmbBookCode.Text) & "' and BookIssue_Staff.Status='" & cmbStatus.Text & "' order by DueDate desc ", con)
            Dim myDA As OleDbDataAdapter = New OleDbDataAdapter(cmd)
            Dim myDataSet As DataSet = New DataSet()
            myDA.Fill(myDataSet, "BookIssue_Staff")
            myDA.Fill(myDataSet, "Book")
