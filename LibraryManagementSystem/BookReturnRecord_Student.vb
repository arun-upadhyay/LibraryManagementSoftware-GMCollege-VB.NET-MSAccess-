...
Public Class frmBookReturnRecord_Student
    ...
    Private Sub txtBookName_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBookName.TextChanged
        Try
            ...
            Try
                ...
                con.Open()
                cmd = New OleDbCommand("SELECT ReturnID as [Return ID],ReturnDate as [Return Date],Fine, BookIssue_Student.TransactionID as [Transaction ID], IssueDate as [Issue Date], DueDate as [Due Date], Book.AccessionNo as [Accession No],BookIssue_Student.BCode as [Book Code], BookTitle as [Book Title],Author,Subject,ISBN,Edition,Student.StudentID as [Student ID],StudentName as [Student Name],Course,Student.Department from Book,BookIssue_Student,Student,Return_Student where Book.AccessionNo=BookIssue_Student.AccessionNo and BookIssue_Student.StudentID=Student.StudentID  and BookIssue_Student.TransactionID=Return_Student.TransactionID and Returndate Between #" & dtpDateFrom.Text & "# and #" & dtpDateTo.Text & "# and BookTitle like '" & txtBookName.Text & "%' order by Returndate desc ", con)
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            ...
            Me.Hide()
            frmBookReturn.Show()
            frmBookReturn.txtReturnID.Text = dr.Cells("Return ID").Value.ToString()
            frmBookReturn.dtpReturnDate.Text = dr.Cells("Return Date").Value.ToString()
            frmBookReturn.txtFine.Text = dr.Cells("Fine").Value.ToString()
            ...
            frmBookReturn.TextBox1.Text = dr.Cells("Accession No").Value.ToString()
