...
Public Class frmStudentRecord
    ...
    Private Sub DataGridView1_CellStateChanged(sender As Object, e As System.Windows.Forms.DataGridViewCellStateChangedEventArgs) Handles DataGridView1.CellStateChanged
