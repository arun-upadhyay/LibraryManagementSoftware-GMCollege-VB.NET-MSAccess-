...
Public Class Frmlogin
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            myCommand = New OleDbCommand("SELECT users.username,User_password,Usertype FROM Users,Registration where Registration.Username=users.username and Users.Username = @Username and user_password = @UserPassword and UserType=@usertype", myConnection)
            ...
            Dim uType As New OleDbParameter("@Usertype", SqlDbType.VarChar)
